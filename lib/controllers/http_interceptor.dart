...
Future<http.Response> getWithHttp(Uri url, {Map<String, String>? headers}) async {
    //  interceptor logic before making the request
    headers ??= {};
    headers['Authorization'] = 'Bearer $_accessToken';
...
Future<String> refreshAccessToken() async {
  ...
  try {
    ...
    if (response.statusCode != 200) {
      throw Exception('Couldn\'t refresh token');
    }
    if (response.statusCode == 200) {
...
// setStorageLocator() {
//   GetIt getIt.registerLazySingleton<FlutterSecureStorage>(
